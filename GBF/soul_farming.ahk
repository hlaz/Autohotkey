...
start_halo(){
	ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\ap_10.png
	if (ErrorLevel = 0)
	{
...
battle() {
	...
	ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\auto_battle_3.png
	if (ErrorLevel = 0)
	{
		
		randomize_click_battle(FoundX, FoundY)
		random_delay_wait()
	}
