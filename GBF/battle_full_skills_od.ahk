...

{
	...
	Loop
	{
		CoordMode, pixel, screen
		coordmode, mouse, screen
		ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\skill_3.png
		if (ErrorLevel = 0)
		{
			randomize_click_skill(FoundX, FoundY)
			Random,t,5,9
	...
	Loop
	{
		CoordMode, pixel, screen
		coordmode, mouse, screen
		ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\skill_4.png
		if (ErrorLevel = 0)
		{
			randomize_click_skill(FoundX, FoundY)
			Random,t,5,9
	...
	Loop
	{
		CoordMode, pixel, screen
		coordmode, mouse, screen
		ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\skill_8.png
		if (ErrorLevel = 0)
		{
			randomize_click_skill(FoundX, FoundY)
			Random,t,5,9
	...
	Loop
	{
		CoordMode, pixel, screen
		coordmode, mouse, screen
		ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\skill_9.png
		if (ErrorLevel = 0)
		{
			randomize_click_skill(FoundX, FoundY)
			Random,t,5,9
	...
	Loop
	{
		CoordMode, pixel, screen
		coordmode, mouse, screen
		ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\skill_13.png
		if (ErrorLevel = 0)
		{
			randomize_click_skill(FoundX, FoundY)
			Random,t,5,9
	...
	Loop
	{
		CoordMode, pixel, screen
		coordmode, mouse, screen
		ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\skill_6.png
		if (ErrorLevel = 0)
		{
			randomize_click_skill(FoundX, FoundY)
			Random,t,5,9
	...
	Loop
	{
		CoordMode, pixel, screen
		coordmode, mouse, screen
		ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\skill_5.png
		if (ErrorLevel = 0)
		{
			randomize_click_skill(FoundX, FoundY)
			Random,t,5,9
	...
	Loop
	{
		CoordMode, pixel, screen
		coordmode, mouse, screen
		ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\skill_10.png
		if (ErrorLevel = 0)
		{
			randomize_click_skill(FoundX, FoundY)
			Random,t,5,9
	...
	Loop
	{
		CoordMode, pixel, screen
		coordmode, mouse, screen
		ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\skill_7.png
		if (ErrorLevel = 0)
		{
			random_delay_turn()
			randomize_click_skill(FoundX, FoundY)
