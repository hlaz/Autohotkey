...
battle() {
	...
	ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\halo_attack.png
	if (ErrorLevel = 0)
	{
		random_delay()
	...
	ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\halo_auto_battle.png
	if (ErrorLevel = 0)
	{
		randomize_click(FoundX, FoundY)
	}
