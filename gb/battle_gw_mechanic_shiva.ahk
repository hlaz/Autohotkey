...

{
	...
	Loop
	{
		CoordMode, pixel, screen
		coordmode, mouse, screen
		ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\skill_3_mc.png
		if (ErrorLevel = 0)
		{
			randomize_click_skill(FoundX, FoundY)
			Random,t,5,9
	...
	Loop
	{
		CoordMode, pixel, screen
		coordmode, mouse, screen
		ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\skill_6_2.png
		if (ErrorLevel = 0)
		{
			randomize_click_skill(FoundX, FoundY)
			Random,t,5,9
	...
	Loop
	{
		CoordMode, pixel, screen
		coordmode, mouse, screen
		ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\back_1.png
		if (ErrorLevel = 0)
		{
			randomize_click_skill(FoundX, FoundY)
			Random,t,5,9
