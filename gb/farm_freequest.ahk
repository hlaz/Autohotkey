...
start_halo(){
	ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\ap_40.png
	if (ErrorLevel = 0)
	{
		random_delay()
...
battle() {
	...
	ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\img\auto_free.png
	if (ErrorLevel = 0)
	{
