...
Loop
{
	If(IsImagePlus(ClickX, ClickY, "mitama_multi_start.png",60,0))
	{
		starting_delay()
		randomize_click(ClickX, ClickY)
	}
	
	If(IsImagePlus(ClickX, ClickY, "re_invite.png",60,0))
	{
		If(IsImagePlus(ClickX, ClickY, "click_yes_mitama.png",60,0))
		{
			random_delay()
			randomize_click(ClickX, ClickY)
