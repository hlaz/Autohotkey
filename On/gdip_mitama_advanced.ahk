...
Loop
{
	If(IsImagePlus(ClickX, ClickY, "mitama_dungeon.png",60,0))
	{
	...
	If(IsImagePlus(ClickX, ClickY, "floor_3.png",60,0))
	{
		randomize_click(ClickX, ClickY)
		random_delay()
	}
	
	If(IsImagePlus(ClickX, ClickY, "advanced_mitama.png",60,0))
	{
		If(IsImagePlus(ClickX, ClickY, "advanced_mitama_enter.png",60,0))
		{
			randomize_click(ClickX, ClickY)
			random_delay()
		}
